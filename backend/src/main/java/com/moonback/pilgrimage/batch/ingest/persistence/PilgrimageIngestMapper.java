...
import com.moonback.pilgrimage.batch.ingest.model.DiscoveredPost;
...
import com.moonback.pilgrimage.batch.ingest.model.ParsedScene;
...
public interface PilgrimageIngestMapper {
	...
	void saveSuccessfulGeocodeCache(@Param("queryHash") byte[] queryHash, @Param("queryText") String queryText,
			@Param("result") com.moonback.pilgrimage.batch.ingest.geocode.GeocodeResult result);
