...
-- -----------------------------------------------------
-- Schema moonback_trip
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `moonback_trip` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `moonback_trip` ;

DROP TABLE IF EXISTS `moonback_trip`.`attractions` ;
DROP TABLE IF EXISTS `moonback_trip`.`guguns` ;
DROP TABLE IF EXISTS `moonback_trip`.`sidos` ;
DROP TABLE IF EXISTS `moonback_trip`.`contenttypes` ;
-- -----------------------------------------------------
-- Table `moonback_trip`.`sidos`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `moonback_trip`.`sidos` (
...
-- -----------------------------------------------------
-- Table `moonback_trip`.`guguns`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `moonback_trip`.`guguns` (
  ...
  CONSTRAINT `guguns_sido_to_sidos_cdoe_fk`
    ...
    REFERENCES `moonback_trip`.`sidos` (`sido_code`))
ENGINE = InnoDB
AUTO_INCREMENT = 235
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `moonback_trip`.`contenttypes`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `moonback_trip`.`contenttypes` (
...
-- -----------------------------------------------------
-- Table `moonback_trip`.`attractions`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `moonback_trip`.`attractions` (
  ...
  CONSTRAINT `attractions_sigungu_to_guguns_gugun_fk`
    ...
    REFERENCES `moonback_trip`.`guguns` (`gugun_code`),
  CONSTRAINT `attractions_typeid_to_types_typeid_fk`
    FOREIGN KEY (`content_type_id`)
    REFERENCES `moonback_trip`.`contenttypes` (`content_type_id`))
ENGINE = InnoDB
