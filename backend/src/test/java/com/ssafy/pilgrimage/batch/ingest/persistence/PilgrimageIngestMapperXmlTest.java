...
class PilgrimageIngestMapperXmlTest {
	...
	void mapperXmlLoadsWithoutAnnotationSql() throws Exception {
		...
		assertThat(configuration.hasStatement(
				"com.ssafy.pilgrimage.batch.ingest.persistence.PilgrimageIngestMapper.countDrama")).isTrue();
		assertThat(configuration.hasStatement(
				"com.ssafy.pilgrimage.batch.ingest.persistence.PilgrimageIngestMapper.upsertDrama")).isTrue();
	}
}
